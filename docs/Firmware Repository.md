...
| Type   | Version          | Root Strategy | Mirror |
|:------:|:-----------------|:--------------|:-------|
| 2      | 17.2.0188-820-RA | #2            | *None, **no RBI available**!, this version has been found on some devices. If you have it on your device please share a dump! Ask for help if you don't know how to get the dump.* |
